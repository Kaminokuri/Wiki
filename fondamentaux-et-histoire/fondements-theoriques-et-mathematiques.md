...
4.  [**Représentation des Données**](/fondamentaux-et-histoire/fondements-theoriques-et-mathematiques/representation-donnees.md) : Focus technique sur l'encodage (ASCII/UTF-8), le petit/grand boutisme (Endianness) et les nombres flottants.
